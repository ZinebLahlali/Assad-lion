...
<body class="bg-gray-900 text-white flex h-screen" >
  ...
  <div class="w-64 bg-gray-800 flex flex-col p-4">
    ...
    <nav class="flex flex-col gap-4">
     ...
     <a href=""> <button class="nav-btn px-4 py-2 rounded hover:bg-gray-700" data-page="visites">Guided Visits</button> </a>
  ...
  <div class="flex-1 p-6 overflow-auto">
    <!-- Animals -->
    <div class="page hidden" id="animals">
      <h2 class="text-2xl font-bold mb-4">Animals</h2>
      <p>View and manage all animals.</p>
    </div>
